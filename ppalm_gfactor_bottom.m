%% step-7: automatically detects spots in the bottom channel based on the spots picked in top channel
function ppalm_gfactor_bottom
clc
clear
len=2000;
fold_name='C:\H Drive Back Up\Selfmade Programs\ppalm new\';
file_name='D1prewash001.ome';
quantum_yield=0.96;
%%%%%% functions
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pixel_size=118; %% nm
...
spot_details=load([fold_name file_name 'overall_top2_sorted' '.txt']);
...
spot_details_bottom=[frame',xx',xx_nm',x_width',yy',yy_nm',y_width',photon_c_bottom'];
save([fold_name file_name 'overall_bottom2_added.txt'],'-ascii','-TABS','spot_details_bottom');
